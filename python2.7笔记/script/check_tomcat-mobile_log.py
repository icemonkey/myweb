...
subject = u'Tomcat日志错误信息tomcat-mobile 12.12 服务器'
...
tomcat_log='/usr/local/tomcat-mobile/logs/catalina.'+time.strftime('%Y-%m-%d')+'.out'
#该文件是用于记录上次读取日志文件的位置,执行脚本的用户要有创建该文件的权限
last_position_logfile = '/tmp/last_position-mobile.txt'
#匹配的错误信息关键字的正则表达式
