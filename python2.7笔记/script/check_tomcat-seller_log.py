...
sender = 'lihanghang@yiwang.com'
password = '1qaz@WSX'
receiver = ('lihanghang@yiwang.com','zhangjianteng@yiwang.com','tanzhenghui@yiwang.com',)
subject = u'Tomcat日志错误信息tomcat-seller 12.12 服务器'
From = u'lihanghang@yiwang.com'
To = u'服务器管理员'
#定义tomcat日志文件位置
#tomcat_log = '/usr/local/apache-tomcat-7.0.69-8020-wx/logs/catalina.out'
#tomcat_log = '/usr/local/apache-tomcat-7.0.69-8020-wx/bin/log/info.log'
#tomcat_log='/usr/local/tomcat-trade/logs/catalina.2017-01-23.out'
tomcat_log='/usr/local/tomcat-seller/logs/catalina.'+time.strftime('%Y-%m-%d')+'.out'
#该文件是用于记录上次读取日志文件的位置,执行脚本的用户要有创建该文件的权限
last_position_logfile = '/tmp/last_position-seller.txt'
#匹配的错误信息关键字的正则表达式
